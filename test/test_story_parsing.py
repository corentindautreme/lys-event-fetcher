...
class StoryParsingTest(unittest.TestCase):
    def test_if_story_contains_valid_date_then_event_should_be_extracted(self):
        ...
        self.assertTrue(date[:10] == "2021-02-15")
    ...
    def test_if_story_contains_some_valid_dates_then_associated_events_should_be_extracted(self):
        ...
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-02-08")
        self.assertTrue(suggestion.dateTimesCet[1]['dateTimeCet'][:10] == "2021-02-10")
        self.assertTrue(suggestion.dateTimesCet[2]['dateTimeCet'][:10] == "2021-02-22")
    ...
    def test_if_story_contains_numerical_values_that_are_not_dates_these_should_not_be_extracted(self):
        ...
        suggestion = get_suggestion_for_story(story, current_datetime=datetime.datetime(2020, 9, 1, 0, 0, 0), country_data=country_data)
        self.assertTrue(len(suggestion.dateTimesCet) == 1)
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-01-25")
    ...
    def test_full_article_non_regression_testing_1(self):
        ...
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-02-06")
        self.assertTrue(suggestion.dateTimesCet[1]['dateTimeCet'][:10] == "2021-02-13")
        self.assertTrue(suggestion.dateTimesCet[2]['dateTimeCet'][:10] == "2021-02-20")
        self.assertTrue(suggestion.dateTimesCet[3]['dateTimeCet'][:10] == "2021-02-27")
        self.assertTrue(suggestion.dateTimesCet[4]['dateTimeCet'][:10] == "2021-03-06")
        self.assertTrue(suggestion.dateTimesCet[5]['dateTimeCet'][:10] == "2021-03-13")
    ...
    def test_full_article_non_regression_testing_2(self):
        ...
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-02-02")
        self.assertTrue(suggestion.dateTimesCet[1]['dateTimeCet'][:10] == "2021-02-09")
        self.assertTrue(suggestion.dateTimesCet[2]['dateTimeCet'][:10] == "2021-02-16")
        self.assertTrue(suggestion.dateTimesCet[3]['dateTimeCet'][:10] == "2021-02-23")
    ...
    def test_full_article_non_regression_testing_3(self):
        ...
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-01-21")
        self.assertTrue(suggestion.dateTimesCet[1]['dateTimeCet'][:10] == "2021-03-07")
    ...
    def test_full_article_non_regression_testing_4(self):
        ...
        suggestion = get_suggestion_for_story(story, current_datetime=datetime.datetime(2020, 9, 1, 0, 0, 0), country_data=country_data)
        self.assertTrue(len(suggestion.dateTimesCet) == 1)
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-03-07")
    ...
    def test_full_article_non_regression_testing_5(self):
        ...
        suggestion = get_suggestion_for_story(story, current_datetime=datetime.datetime(2020, 9, 1, 0, 0, 0), country_data=country_data)
        self.assertTrue(len(suggestion.dateTimesCet) == 6)
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-01-11")
        self.assertTrue(suggestion.dateTimesCet[1]['dateTimeCet'][:10] == "2021-01-18")
        self.assertTrue(suggestion.dateTimesCet[2]['dateTimeCet'][:10] == "2021-01-25")
        self.assertTrue(suggestion.dateTimesCet[3]['dateTimeCet'][:10] == "2021-02-01")
        self.assertTrue(suggestion.dateTimesCet[4]['dateTimeCet'][:10] == "2021-02-08")
        self.assertTrue(suggestion.dateTimesCet[5]['dateTimeCet'][:10] == "2021-02-15")
    ...
    def test_full_article_non_regression_testing_6(self):
        ...
        suggestion = get_suggestion_for_story(story, current_datetime=datetime.datetime(2020, 9, 1, 0, 0, 0), country_data=country_data)
        self.assertTrue(len(suggestion.dateTimesCet) == 1)
        self.assertTrue(suggestion.dateTimesCet[0]['dateTimeCet'][:10] == "2021-02-15")
