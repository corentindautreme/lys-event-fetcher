...
class ExtractionUtilsTest(unittest.TestCase):
    ...
    def test_if_another_start_every_end_expression_then_should_extract_all_events(self):
        sentence = "Melodifestivalen will start on February 6 2021 and run every Saturday until March 13 2021 on SVT1"
        events = check_for_repetition_expression(sentence)
        self.assertEqual(len(events), 6)
        ...
        # verify context
        self.assertTrue(events[0][0] == events[1][0] == events[2][0] == events[3][0] == events[4][0] == events[5][0])
        self.assertTrue(events[0][0] == "start on February 6 2021 and run every Saturday until March 13 2021")
    ...
    def test_if_yet_another_every_from_to_expression_then_should_extract_all_events(self):
        sentence = "Melodifestivalen will take place every Saturday from February 6 2021 to March 13 2021"
        events = check_for_repetition_expression(sentence)
        self.assertEqual(len(events), 6)
        self.assertTrue(events[0][1].strftime("%Y-%m-%d")[5:] == "02-06")
        self.assertTrue(events[1][1].strftime("%Y-%m-%d")[5:] == "02-13")
        ...
        # verify context
        self.assertTrue(events[0][0] == events[1][0] == events[2][0] == events[3][0] == events[4][0] == events[5][0])
        self.assertTrue(events[0][0] == "every Saturday from February 6 2021 to March 13 2021")
    ...
    def test_if_another_from_to_every_expression_then_should_extract_all_events(self):
        sentence = "Melodifestivalen will run from February 6 2021 to March 13 2021 every Saturday on SVT1"
        events = check_for_repetition_expression(sentence)
        self.assertEqual(len(events), 6)
        self.assertTrue(events[0][1].strftime("%Y-%m-%d")[5:] == "02-06")
        self.assertTrue(events[1][1].strftime("%Y-%m-%d")[5:] == "02-13")
        ...
        # verify context
        self.assertTrue(events[0][0] == events[1][0] == events[2][0] == events[3][0] == events[4][0] == events[5][0])
        self.assertTrue(events[0][0] == "from February 6 2021 to March 13 2021 every Saturday")
